...
export const HERO_COUNTERS: HeroCounters = {
  Abrams: [
    {
      ...
      cost: 1600,
      category: 'Passive',
      effect: 'Auto-barrier on CC (Shoulder Charge)',
    },
  ...
  Billy: [
    { name: 'Healbane', cost: 1250, category: 'Anti-Heal', effect: '35% heal reduction' },
    {
      ...
      cost: 3000,
      category: 'Anti-Heal',
      effect: 'Bleed + 30% heal reduction',
    },
  ],
  Calico: [
  ...
  'The Doorman': [
    {
      ...
      cost: 1600,
      category: 'Passive',
      effect: 'Auto-barrier on Cart Combo',
    },
  ],
  Drifter: [{ name: 'Divine Barrier', cost: 6200, category: 'Bonus', effect: 'Cleanse ultimate' }],
  Dynamo: [
  ...
  'Grey Talon': [
    {
      ...
      cost: 3000,
      category: 'Passive',
      effect: 'Best spirit resist - makes him useless',
    },
  ...
  Haze: [
    ...
    { name: 'Metal Skin', cost: 3000, category: 'Bonus', effect: '5s bullet immunity' },
    {
      ...
      cost: 3000,
      category: 'Passive',
      effect: 'Bullet resist + fire rate',
    },
  ],
  Holliday: [
  ...
  Ivy: [{ name: 'Slowing Hex', cost: 1250, category: 'Active', effect: 'Stop ultimate' }],
  Kelvin: [
  ...
  Lash: [{ name: 'Counterspell', cost: 3000, category: 'Active', effect: 'Parry Slam' }],
  Mirage: [
    { name: 'Slowing Hex', cost: 1250, category: 'Active', effect: 'Stop bat escape' },
    {
      ...
      cost: 1250,
      category: 'Anti-Heal',
      effect: '70% heal reduction + massive damage',
    },
    { name: 'Healbane', cost: 1250, category: 'Anti-Heal', effect: '35% heal reduction' },
  ],
  'Mo & Krill': [
    {
      ...
      cost: 1250,
      category: 'Passive',
      effect: 'Reduces ultimate duration',
    },
    {
      name: 'Knockdown',
      cost: 3000,
      category: 'Active',
      effect: 'Cancel ultimate + stop burrowing',
    },
  ...
  Pocket: [{ name: 'Divine Barrier', cost: 6200, category: 'Bonus', effect: 'Cleanse ultimate' }],
  Seven: [{ name: 'Capacitor', cost: 6200, category: 'Bonus', effect: 'Remove Power Surge buff' }],
  Shiv: [
    { name: 'Healbane', cost: 1250, category: 'Anti-Heal', effect: '35% heal reduction' },
    {
      name: 'Toxic Bullets',
  ...
  Victor: [
    { name: 'Healbane', cost: 1250, category: 'Anti-Heal', effect: '35% heal reduction (early)' },
    {
      ...
      cost: 6200,
      category: 'Anti-Heal',
      effect: '-18% resists + 30% heal reduction',
    },
    {
      name: 'Inhibitor',
      cost: 6200,
      category: 'Anti-Heal',
      effect: '35% heal reduction + 35% damage reduction',
    },
  ],
  Vindicta: [
    {
      ...
      cost: 3000,
      category: 'Passive',
      effect: 'Protection against snipes',
    },
  ],
  Viscous: [
    {
      ...
      cost: 1250,
      category: 'Active',
      effect: 'Parry Puddle Punch and return damage',
    },
    { name: 'Capacitor', cost: 6200, category: 'Bonus', effect: 'Remove cube buffs' },
  ],
  Wraith: [{ name: 'Suppressor', cost: 1250, category: 'Bonus', effect: '-30% fire rate' }],
  Yamato: [
    { name: 'Silence Wave', cost: 3000, category: 'Active', effect: 'Suppress low HP ultimate' },
    { name: 'Healbane', cost: 1250, category: 'Anti-Heal', effect: '35% heal reduction' },
  ],
